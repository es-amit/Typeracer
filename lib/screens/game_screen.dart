...
import 'package:typeracer_clon/widgets/game_text_field.dart';
import 'package:typeracer_clon/widgets/sentence_game.dart';
                  ...
                  itemBuilder: ((context, index) {
                    return Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Chip(
                            label: Text(game.gameState['players'][index]['nickname'],
                            style: const TextStyle(
                              fontSize: 18
                            ),),
                          ),
